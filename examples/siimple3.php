...
flash()->setTemplate(TemplateFactory::create(Templates::SIIMPLE_3));
...
<head>
    <meta charset="UTF-8">
    <title>Test Siimple 3 template example.</title>
    <!-- Latest compiled and minified CSS -->
    <link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Montserrat:400,700">
    <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/siimple@3.1.1/dist/siimple.min.css">
</head>
<body>
